...
Polynomial.prototype = {
    ...
    locateElem: function locateElem(elem, compare) {
    ...
    createPolyn: function createPolyn(elems, elems2) {
        var m = elems.length;
        this.initList();
        var h = this.head;
        var e = h.data;
...
test.addPolyn(test2);
console.log((0, _stringify2.default)(test));
